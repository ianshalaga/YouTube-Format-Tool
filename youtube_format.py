...
def generar_descripcion(nombre_salida_marcas_tiempo,
    ...
    player_string += "Seyfer Studios Lightning Team Tournament 2 (PS4): " + "https://www.youtube.com/playlist?list=PL90QAKwVH1t4FJ0qREuwdvE4DAXN_00VV" + "\n"
    player_string += "Brackets: " + "https://challonge.com/es/1f4tyz0w" + "\n"
